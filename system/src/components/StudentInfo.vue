<template>
  ...
  >
    ...
    <div style="text-align: left; padding-left: 160px">
      ...
      <span
        class="bigFontSize"
        style="font-size: 25px; position: relative; top: 10px"
        >姓名:&emsp;{{ name }}</span
      >
      <br />
      <span
        class="bigFontSize"
        style="font-size: 25px; position: relative; top: 20px"
        >学号:&emsp;{{ id }}</span
      >
      <br />
      <span
        class="bigFontSize"
        style="font-size: 25px; position: relative; top: 30px"
        >专业:&emsp;{{ major }}</span
      >
      <br />
      <span
        class="bigFontSize"
        style="font-size: 25px; position: relative; top: 40px"
        >入学年份:&emsp;{{ grade }}</span
      >
      <br />
      <span
        class="bigFontSize"
        style="font-size: 25px; position: relative; top: 50px"
        >已修学分:&emsp;{{ credit }}</span
      >
      <br />
    </div>
    <el-image
