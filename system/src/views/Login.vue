...
<template>
    ...
    >
      <div class="login">
        ...
        <br/>      
        <strong style="font-family:仿宋;font-size:25px;color:white;">欢迎登录</strong>
        <el-divider></el-divider>
        <el-form label-width="80px" class="item" style="font-color:white">
          <el-form-item label="账号" prop="Id">
            <el-input placeholder="请输入账号" v-model="Id" style="width:85%"></el-input>
          </el-form-item>
          ...
          <el-form-item style="margin-top:20px">
            <el-button type="primary" plain style="background-color: rgba(0, 0, 0, 0.3);margin-left:-60px" @click="login">
              <i class="el-icon-edit"></i>
              登录
              </el-button>
            <el-button type="warning" plain style="background-color: rgba(0, 0, 0, 0.3)" @click="openRegister">
